...
var thisjs = new function() {
	...
	this.cart_add = function(o) {
		...
		var html = '';
		if( o.type==6) {
			html = '<li class="x_menu2" style="background:url'+'(' + o.pic + ') no-repeat;" onmouseover="kj.show(kj.obj(\'img\',this));"  onmouseout="kj.hide(kj.obj(\'img\',this));" onclick="thisjs.cart_del('+index+')" title="'+o.name+'"><img src="/webcss/default/images/btn_del.gif" style="display:none"></li>';
		} else {
			html = '<li class="x_menu" style="background:url'+'(' + o.pic + ') no-repeat;" onmouseover="kj.show(kj.obj(\'img\',this));"  onmouseout="kj.hide(kj.obj(\'img\',this));" onclick="thisjs.cart_del('+index+')" title="'+o.name+'"><img src="/webcss/default/images/btn_del.gif" style="display:none"></li>';
			//非第三个时，显示加号
			i = index+1;
	...
	this.cart_go = function(index) {
		...
		for(var i = 0 ; i < len ; i++) {
			if(this.cart[this.index][0].type!=6) {
				html += '<li class="x_menu" style="background:url'+'(' + this.cart[this.index][i].pic + ') no-repeat;" onmouseover="kj.show(kj.obj(\'img\',this));"  onmouseout="kj.hide(kj.obj(\'img\',this));" onclick="thisjs.cart_del('+i+')" title="'+this.cart[this.index][i].name+'"><img src="/webcss/default/images/btn_del.gif" style="display:none"></li>';
				j = i+1;
				if(j%3 != 0) html += '<li class="x_plus">&nbsp;</li>';
			} else {
				html += '<li class="x_menu2" style="background:url'+'(' + this.cart[this.index][i].pic + ') no-repeat;" onmouseover="kj.show(kj.obj(\'img\',this));"  onmouseout="kj.hide(kj.obj(\'img\',this));" onclick="thisjs.cart_del('+i+')" title="'+this.cart[this.index][i].name+'"><img src="/webcss/default/images/btn_del.gif" style="display:none"></li>';
				break;
			}
		}
		var objbox = kj.obj("#id_cart_box");
